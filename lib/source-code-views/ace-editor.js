...
var sampleCode = {
    ...
    sumLoop: `var array = [0, 1, 2, 3, 4, 5],
    sum = 0;

for (var i = 0; i < array.length; i++)
  sum += array[i];`,

    sumReduce: `var array = [0, 1, 2, 3, 4, 5];
...
$('<button>Sum Reduce</button>')
    .click(() => setExampleCode(sampleCode.sumReduce))
    .appendTo(newWidget(0,0,2,1));

$('<button>Fibonacci</button>')
    .click(() => setExampleCode(sampleCode.fibonacci))
    .appendTo(newWidget(0,0,2,1));

$('<button>Square</button>')
    .click(() => setExampleCode(sampleCode.square))
    .appendTo(newWidget(0,0,2,1));
