...
function openContextMenuFor(d,i) {
    ...
    ['apple', 'grapefruit', 'banana'].forEach(item => {
        var listItem = document.createElement('li');
        listItem.innerHTML = item;
        listItem.onclick = event => console.log(event);
...
// TODO: needs .css for absolute positioning
// TODO: extract ContextMenu into its own file
(function() {
    d3.select(newWidget(0, 0, 2, 2)).append("svg").append("circle")
        .attr("cx", 30)
        .attr("cy", 30)
        .attr("r", 20)
        .on('contextmenu', openContextMenuFor);
})();
